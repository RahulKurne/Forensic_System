		...
		<section id="main-content">
			<section class="wrapper">
				...
				<div class="container">
					...
					<h1 class="text-center">Update Supervisor</h1>

					<form:form method="post" action="/forensic_system/saveSuperUpdate">
						<form:hidden path="super_id" />

						<div class="form-row">

							<div class="form-group col-md-6">
								<form:input path="f_name" class="form-control" readonly="true" />
							</div>
							<br> <br>

							<div class="form-group col-md-6">
								<form:input path="l_name" class="form-control" readonly="true" />
							</div>
							<br> <br>
