...
<!-- full calendar css-->
<link href="/forensic_system/URLToResourcesFolder/assets/fullcalendar/fullcalendar/bootstrap-fullcalendar.css"
	rel="stylesheet" />
<link href="/forensic_system/URLToResourcesFolder/assets/fullcalendar/fullcalendar/fullcalendar.css"
	rel="stylesheet" />
<!-- easy pie chart-->
<link href="/forensic_system/URLToResourcesFolder/assets/jquery-easy-pie-chart/jquery.easy-pie-chart.css"
...
<body>
		...
		<section id="main-content">
			<section class="wrapper">
				...
				<div class="container">
					...
					<form action="addOffi" method="POST">
						<div class="form-row">
							<div class="form-group col-md-12">
								<h1 class="display-4">Add Officer</h1>
							</div>
							...
							<div class="form-group col-md-6">
								<label for="birthDate" class="col-sm-3 control-label">Date
									of Joining</label> <input type="date" id="birthDate"
								...
								<div class="form-group col-md-6">
									<div class="form-check-inline">
										<label class="form-check-label"> <input type="radio"
											class="form-check-input" id="gender" name="gender">Male
										</label>
									</div>
									<div class="form-check-inline">
										<label class="form-check-label"> <input type="radio"
											class="form-check-input" id="gender" name="gender">Female
										</label>
									</div>
								</div>
							</div>
						...
						<button type="submit" class="btn btn-success" name="save_Offi">Save
							Officer</button>
					</form>
				</div>
	...
	<script type="/forensic_system/URLToResourcesFolder/text/javascript" src="js/jquery-ui-1.9.2.custom.min.js"></script>
	<!-- bootstrap -->
