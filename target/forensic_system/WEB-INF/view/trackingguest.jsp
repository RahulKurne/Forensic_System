    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu">
          ...
          <li>
             <a class="" href="/forensic_system/URLToResourcesFolder/createcasefile.html"> 
                          <!-- <i class="icon_genius"></i> -->
                          <span>Create case files</span>
                      </a>
          </li>
          <li>
             <a class="" href="/forensic_system/URLToResourcesFolder/updatecasefile.html"> 
                          <!-- <i class="icon_genius"></i> -->
                          <span>Update case files</span>
                      </a>
          </li>
           <li>
             <a class="" href="/forensic_system/URLToResourcesFolder/guestadd.html"> 
                          <!-- <i class="icon_genius"></i> -->
                          <span>Add guest</span>
                      </a>
          </li>
           <li>
             <a class="" href="/forensic_system/URLToResourcesFolder/trackingguest.html"> 
                          <!-- <i class="icon_genius"></i> -->
                          <span>Track guest activity</span>
                      </a>
          </li>
           <li>
             <a class="" href="/forensic_system/URLToResourcesFolder/genratesheet.html"> 
                          <!-- <i class="icon_genius"></i> -->
                          <span>Genrate chart sheet</span>
                      </a>
          </li>
           <li>
             <a class="" href="/forensic_system/URLToResourcesFolder/sendmail.html"> 
                          <!-- <i class="icon_genius"></i> -->
                          <span>Send charge sheet to court</span>
                      </a>
          </li>
           <li>
             <a class="" href="/forensic_system/URLToResourcesFolder/oldcase.html"> 
                          <!-- <i class="icon_genius"></i> -->
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="col-sm-8 col-sm-offset-2">
            <div class="panel panel-primary">
              <div class="panel-heading" style="margin-left: 150px;">
                <div class="text-center"><h1>Tacking Guest Activity</h1></div>
                    ...
                    <form class="container">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-4 col-sm-offset-2">
                          <button type="submit" class="btn btn-primary" >Track Guest</button>
      ...
      <div class="text-right">
        <div class="credits">
          ...
          -->
          Designed by <a href="https://#.com/">Mahesh From Cravita Technology</a>
        </div>
      </div>
    </section> 
