    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu">
          <li class="active">
            <a class="" href="generaluser">
                          <i class="icon_house_alt"></i>
                          <span>Dashboard</span>
                      </a>
          </li>
          <li class="sub-menu">
            <a href="genraluser" class="">
                          <!-- <i class="icon_document_alt"></i> -->
                          <span>Genral User</span>
          ...
          <li>
             <a class="" href="genraluser"> 
                          <!-- <i class="icon_genius"></i> -->
                          <span>View Cases Info</span>
                      </a>
          </li>
          <li>
             <a class="" href="genraluserenquery"> 
                          <!-- <i class="icon_genius"></i> -->
 ...
 <div class="container" style="height: 500px;
  ...
  <div class="form-row">
      <div class="form-group col-md-12">
            <h1 class="display-4" style="text-align: center;">Enquiry Mail</h1>
      </div>
    ...
    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" cols="135"></textarea>
  </div>
 </div>
  ...
  <button type="submit" class="btn btn-success" style="text-align:  center;">Send Mail</button>
  </div>
</form>
</div>
</div>
