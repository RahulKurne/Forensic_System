...
<body>
		...
		<section id="main-content">
			<section class="wrapper">
				...
				<div class="container">
					...
					<%-- <c:forEach var="cs" items="${command1}">
					<br>
					<br>
					<br>
					<br>
					...
					<form:form method="post" action="/forensic_system/saveSuperUpdate">
						...
						<div class="form-row">
							...
							<div class="form-group col-md-6">
								<form:input path="case_name" class="form-control" readonly="true" />
							</div>
							<br> <br>

							<div class="form-group col-md-6">
								<form:input path="c_name" class="form-control" readonly="true" />
							</div>
							<br> <br>
							...
							<label for="inputAddress">Current Address</label> 
								<form:input path="c_add" class="form-control" />
							</div>
							<br> <br>

							<div class="form-group col-md-12">
							<label for="inputAddress2">Permanent Address</label> 
								<form:input path="p_add" class="form-control" />
							</div>
							<br> <br>
						</div>
	...
	<!-- javascripts -->
	<script type="/forensic_system/URLToResourcesFolder/js/datepicker.js"></script>
	...
	<script type="/forensic_system/URLToResourcesFolder/text/javascript"
