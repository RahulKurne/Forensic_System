		...
		<aside>
			<div id="sidebar" class="nav-collapse ">
				...
				<ul class="sidebar-menu">
					...
					<li class="sub-menu"><a href="admin.html" class=""> <!-- <i class="icon_document_alt"></i> -->
              ...
              <li><a class="" href="form_validation.html">Form Validation</a></li>
					...
					<li class="sub-menu"><a href="javascript:;" class=""> <!--  <i class="icon_desktop"></i> -->
						...
						<li class="sub-menu"><a href="javascript:;" class=""> <!--  <i class="icon_desktop"></i> -->
							<span>Cases</span> <span class="menu-arrow arrow_carrot-right"></span>
					</a>
						<ul class="sub">
							<li><a class="" href="addGuest">Add Cases</a></li>
							<li><a class="" href="viewGuest">View Cases</a></li>
		...
		<section id="main-content">
			<section class="wrapper">
				...
				<div class="container">
					...
					<h1 class="text-center">Supervisors</h1>
					...
					<table class="table">
						...
						<c:forEach var="sup" items="${Supervisors}">
							<tr>
								<td>${sup.super_id}</td>
								<td>${sup.f_name}</td>
								<td>${sup.l_name}</td>
								...
								<td>${sup.zip}</td>
								<td>${sup.doj}</td>
								<td><button class="btn btn-info"><a href="updateSuper/${sup.super_id}">Update</a></button></td>
								<td><button class="btn btn-danger"><a href="deleteSuper/${sup.super_id }">Delete</a></button></td>
							</tr>
						</c:forEach>
					</table>
				</div>
