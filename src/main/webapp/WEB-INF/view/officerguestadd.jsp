    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu">
          ...
          <li>
             <a class="" href="viewCases"> 
                          <!-- <i class="icon_genius"></i> -->
                          <span>view Cases</span>
                      </a>
          </li>
           <li>
             <a class="" href="officerguestadd"> 
                          <!-- <i class="icon_genius"></i> -->
                          <span>Add guest</span>
                      </a>
          </li>
           ...
           <li>
             <a class="" href="officerviewoldcase"> 
                          <!-- <i class="icon_genius"></i> -->
      ...
      <form action="addGuest" method="POST">
						<div class="form-row">
							<div class="form-group col-md-12">
								<h1 class="display-4">Add Guest</h1>
							</div>
						...
						<button type="submit" class="btn btn-success" name="save_guest">Save Guest</button>
					</form>
</div>
