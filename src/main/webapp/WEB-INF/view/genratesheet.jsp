        ...
        <ul class="nav pull-right top-menu">
          ...
          <li class="dropdown">
            ...
            <ul class="dropdown-menu extended logout">
             ...
             <li class="eborder-top">
                <a href="/forensic_system/URLToResourcesFolder/login.html"><i class="fas fa-sign-in-alt"></i> Login</a>
              </li>
        ...
        <div class="col-sm-8 col-sm-offset-2">
            <div class="panel panel-primary" style="margin-left: 150px; margin-top: 100px;">
              <div class="panel-heading">
                <div class="text-center"><h1>Download Sheet</h1></div>
                    ...
                    <form class="container">
                      ...
                      <div class="form-group">
                        <!-- Buttons -->
                          ...
                          <a href="forensic sheet.pdf" class="sheet">DOWNLOAD SHEET</a>
                          <style type="text/css">
                            .sheet{
                              color: red;
                              font-size: 25px;
