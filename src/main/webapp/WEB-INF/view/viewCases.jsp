			...
			<div class="top-nav notification-row">
				...
				<ul class="nav pull-right top-menu">
					...
					<li class="dropdown"><a data-toggle="dropdown"
						...
						</span> <span class="username">Officer</span> <b class="caret"></b>
					</a>
		...
		<aside>
			<div id="sidebar" class="nav-collapse ">
              ...
              <li><a class="" href="/forensic_system/URLToResourcesFolder/view.html">view</a></li>
					...
					<li><a class=""
						href="officerguestadd"> <!-- <i class="icon_genius"></i> -->
							<span>Add guest</span>
					</a></li>
					<li><a class=""
						href="tackingguest.html">
		...
		<section id="main-content">
			<section class="wrapper">
				...
				<div class="container">
					...
					<div class="controls">
					<button><a type="button" class="btn btn-normal" href="${pageContext.request.contextPath }/report" target="_blank">Generate Report</a></button>
					</div>
					...
					<table class="table">
						...
						<thead>
							<tr>
								...
								<th scope="col">Suspected Name</th>
						...
						<c:forEach var="cs" items="${Cases}">
							<tr>
								...
								<td><button class="btn btn-info"><a href="updateCase/${cs.c_id}">Update</a></button></td>
